...
public static class Loc
{
    ...
    private static readonly Dictionary<string, S> _s = new()
    {
        ...
        // ---- Pro / промокод ----
        ["pro.title"]       = new("Только в Pro", "Лише у Pro", "Pro only"),
        ["pro.benchmark"]   = new("Бенчмарк «до/после» с графиком фреймтайма — функция Pro. Открой Pro (7 дней бесплатно после установки или промокодом) в разделе «Настройки».",
        ...
        ["pro.tier.free"]   = new("Free", "Free", "Free"),
        ["pro.tier.pro"]    = new("Pro", "Pro", "Pro"),
        ["pro.trial"]       = new("Pro-триал: осталось {0} дн.", "Pro-тріал: лишилось {0} дн.", "Pro trial: {0} days left"),
        ["pro.active"]      = new("Pro активирован — спасибо!", "Pro активовано — дякую!", "Pro activated — thank you!"),
        ["pro.promo.title"] = new("Активировать Pro", "Активувати Pro", "Activate Pro"),
        ["pro.promo.hint"]  = new("Есть промокод? Введи его, чтобы открыть Pro навсегда. Покупка — скоро.", "Є промокод? Введи його, щоб відкрити Pro назавжди. Купівля — скоро.", "Have a promo code? Enter it to unlock Pro forever. Purchase — coming soon."),
