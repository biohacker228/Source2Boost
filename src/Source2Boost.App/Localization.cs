...
public static class Loc
{
    ...
    private static readonly Dictionary<string, S> _s = new()
    {
        ...
        ["monitor.auto.loading"] = new("Гружу карту бенчмарка… (25 сек)", "Вантажу карту бенчмарку… (25 с)", "Loading the benchmark map… (25s)"),
        ["monitor.auto.vprof"] = new("Карта сообщила: Avg={0}, 1% low={1}", "Карта повідомила: Avg={0}, 1% low={1}", "Map reported: Avg={0}, 1% low={1}"),
