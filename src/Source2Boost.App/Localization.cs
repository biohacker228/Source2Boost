...
public static class Loc
{
    ...
    private static readonly Dictionary<string, S> _s = new()
    {
        ...
        ["monitor.baseline.cur"] = new("Эталон «до»: FPS {0} · 1% low {1} · стуттер {2} мс · ровность {3}",
                                       "Еталон «до»: FPS {0} · 1% low {1} · стуттер {2} мс · рівність {3}",
                                       "Baseline \"before\": FPS {0} · 1% low {1} · stutter {2} ms · spread {3}"),
